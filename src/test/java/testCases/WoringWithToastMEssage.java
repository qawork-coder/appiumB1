...
public class WoringWithToastMEssage {
	...
	public static void main(String[] args) {
		...
		and.findElementById("com.androidsample.generalstore:id/btnLetsShop").click();
		
		System.out.println(and.findElementByXPath("//android.widget.Toast[1]").getAttribute("name"));
